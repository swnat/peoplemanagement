...
export declare class CommentReviewPane {
     ...
     * @private
     */
    showHidePane(show: boolean): void;
    ...
    insertComment(): void;
    addComment(comment: CommentElementBox, isNewComment: boolean): void;
    ...
    addReply(comment: CommentElementBox, newComment: boolean): void;
