...
.e-query-builder .e-group-header .e-checkbox-wrapper label {
  margin-left: -7px;
}

.e-query-builder .e-group-header .e-checkbox-wrapper.e-btn.e-small {
...
.e-query-builder .e-group-header .e-small.e-checkbox-wrapper .e-label {
  font-size: 12px;
  font-weight: 600;
  position: relative;
  top: -1px;
...
.e-query-builder .e-group-header .e-small.e-checkbox-wrapper .e-icons {
  position: relative;
  top: -1px;
}
...
.e-query-builder.e-device .e-small.e-checkbox-wrapper .e-label, .e-bigger.e-query-builder .e-small.e-checkbox-wrapper .e-label, .e-bigger .e-query-builder .e-small.e-checkbox-wrapper .e-label {
  font-size: 14px;
}
...
.e-query-builder .e-group-header .e-btn-group .e-checkbox-wrapper:last-of-type {
