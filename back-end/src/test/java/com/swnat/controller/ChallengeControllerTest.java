...
public class ChallengeControllerTest {
    ...
    public void saveChallengeTest() throws Exception {
        ...
        Challenge challenge = TestUtils.buildChallengeTest();
        when(challengeService.add(any(Challenge.class))).
        thenReturn(challenge);

        String requestJson= TestUtils.jsonStringFromObject(challenge);

        // execute
         MvcResult result = mockMvc.perform(MockMvcRequestBuilders.post(TestUtils.CHALLENGE_URL).
        ...
        verify(challengeService).add(any(Challenge.class));
    }
    ...
    public void updateChallengeTest() throws Exception {
        ...
        // execute
        MvcResult result = mockMvc.perform(MockMvcRequestBuilders.post(TestUtils.CHALLENGE_URL+"{id}", challenge.getId()).
        contentType(MediaType.APPLICATION_JSON_UTF8).
        accept(MediaType.APPLICATION_JSON_UTF8).
        content(requestJson)).andReturn();
